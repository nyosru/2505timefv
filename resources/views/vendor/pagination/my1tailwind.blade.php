            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    ...
                    @else
                        ...
                        duration-150
{{--                        dark:bg-gray-800 dark:border-gray-600 dark:active:bg-gray-700 --}}
{{--                        dark:focus:border-blue-800--}}

                        dark:bg-gray-400 dark:border-gray-400 dark:text-gray-800
                       dark:hover:bg-gray-500
...
{{--                                        dark:bg-gray-800 dark:border-gray-600--}}
                                        ...
                                        dark:bg-gray-500 dark:border-gray-500 dark:text-gray-800
...
{{--                                       dark:active:bg-gray-700--}}
                    ...
                    @if ($paginator->hasMorePages())
                        ...
                        ring-gray-300 focus:border-blue-300 active:bg-gray-100
