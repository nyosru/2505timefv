...
{{--            justify-between --}}
            ...
            <a href="{{ route('news') }}"
               class="py-0 px-2 rounded hover:underline {{ request()->routeIs('news*') ? 'bg-red-700 text-white' : '' }}"
            >Новости</a>
            <a href="{{ route('events.index') }}"
               class="py-0 px-2 rounded hover:underline {{ request()->routeIs('events*') ? 'bg-red-700 text-white' : '' }}"
            >Мероприятия</a>
            <a href="{{ route('athletes.index') }}"
               class="py-0 px-2 rounded hover:underline {{ request()->routeIs('athletes*') ? 'bg-red-700 text-white' : '' }}"

            >Спортсмены</a>

            {{--                <a href="#" class="hover:text-primary font-medium">Футбол</a>--}}
            {{--                <a href="#" class="hover:text-primary font-medium">Хоккей</a>--}}
            {{--                <a href="#" class="hover:text-primary font-medium">Баскетбол</a>--}}
            {{--                <a href="#" class="hover:text-primary font-medium">Теннис</a>--}}
            {{--                <a href="#" class="hover:text-primary font-medium">Биатлон</a>--}}
            {{--                <a href="#" class="hover:text-primary font-medium">Формула-1</a>--}}
            {{--                <a href="#" class="hover:text-primary font-medium">Олимпиада</a>--}}
            {{--                <a href="#" class="hover:text-primary font-medium">Другие виды</a>--}}
        </div>

        <!-- Мобильное меню (выпадающее) -->
        <div class="md:hidden py-2">
            <select class="w-full bg-dark text-white p-2 rounded">
