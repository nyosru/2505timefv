<div class="p-4 border rounded shadow-sm max-w-md">
    ...
    <h3 class="text-lg font-semibold mb-4">Компании Организаторы мероприятия</h3>
...
{{--                @if(!$selectedOrganizerId) disabled @endif--}}
    ...
    @if($event->companyOrganizators->isEmpty())
        <p class="text-gray-500">Нет добавленных организаторов.</p>
    @else
        <ul class="space-y-2">
            @foreach($event->companyOrganizators as $organizer)
