<div class="w-full p-6 mt-10">
    ...
    <form wire:submit.prevent="save" enctype="multipart/form-data" novalidate>
        ...
        <div class="flex flex-row flex-wrap w-full">
            ...
            <!-- Название -->
            <div class="w-full sm:w-1/2 bg-orange-100 p-2">
            ...
            <!-- Дата проведения -->
            <div class="w-full sm:w-1/2 bg-green-100 p-2">
            ...
            <!-- Страна -->
            <div class="w-full sm:w-1/2 bg-red-100 p-2">
            ...
            <!-- Описание -->
            <div class="w-full sm:w-1/2 bg-gray-200 p-2">
            ...
            <!-- Фото -->
            <div class="w-full sm:w-1/2  bg-white p-2">
...
{{--                        gap-1--}}
    ...
    @if(1==1)
        ...
        @else
            ...
            Дополнительные параметры можно редактировать после создания мероприятия
            </div>
        @endif
    @endif
</div>
