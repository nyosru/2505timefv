<div class="p-4 border rounded shadow-sm max-w-md">
    ...
    <h3 class="text-lg font-semibold mb-4">Компании участники</h3>
    ...
    @if($news->companyParticipantes->isEmpty())
        <p class="text-gray-500">Текущий список пуст.</p>
    @else
        <ul class="space-y-2">
            @foreach($news->companyParticipantes as $organizer)
