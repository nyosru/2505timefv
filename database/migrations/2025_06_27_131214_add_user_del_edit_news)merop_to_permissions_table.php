...
//        'р.Место проведения' => 70,
        'р.Мероприятия (только свои) / изменить удалить' => 22,
        'р.Мероприятия (только свои) / в админке только свои записи' => 22,
...
//        'р.НовостиАдмин / добавить новость' => 26,
        'р.НовостиАдмин (только свои) / изменить удалить' => 26,
        'р.НовостиАдмин (только свои) / в админке только свои записи' => 26,
